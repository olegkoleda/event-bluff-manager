...
const Index = () => {
  ...
  const [events, setEvents] = useState([
    {
      ...
      description: 'Weekly Texas Hold\'em tournament with friends. Bring your A-game!',
      minParticipants: 4,
      maxParticipants: 8,
      currentParticipants: 6,
      status: 'upcoming' as const,
      userParticipation: 'confirmed' as const
    },
    {
      id: '2',
      ...
      status: 'upcoming' as const,
      userParticipation: 'maybe' as const
    },
    {
      id: '3',
      ...
      description: 'Low-stakes friendly game for beginners and experienced players alike.',
      minParticipants: 3,
      maxParticipants: 6,
  ...
  const handleParticipationChange = (eventId: string, status: 'confirmed' | 'maybe' | null) => {
      ...
      event.id === eventId 
        ? { 
            ...
            currentParticipants: status === 'confirmed' 
              ? event.currentParticipants + (event.userParticipation === 'confirmed' ? 0 : 1)
